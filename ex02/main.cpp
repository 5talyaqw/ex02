...
bool test3Profile()
{
    ...
    try
    {
        ...
        Device device1;
        device1.init(2123, DeviceType::LAPTOP, WINDOWS11);

        Device device2;
        device2.init(3212, DeviceType::PC, UbuntuOS);

        Device device3;
        device3.init(1121, DeviceType::TABLET, WINDOWS10);

        Device device4;
        device4.init(4134, DeviceType::PHONE, ANDROID);

        Device device5;
        device5.init(5522, DeviceType::LAPTOP, MacOS);

        Device device6;
        device6.init(5361, DeviceType::PC, WINDOWS7);

        Device device7;
        device7.init(6611, DeviceType::PHONE, IOS);

        Device device8;
        device8.init(6613, DeviceType::LAPTOP, RedHatOS);

        Device device9;
        device9.init(7711, DeviceType::TABLET, WINDOWS11);

        Device device10;
        device10.init(8181, DeviceType::TABLET, ANDROID);

        Device device11;
        device11.init(8654, DeviceType::LAPTOP, UbuntuOS);

        Device device12;
        device12.init(9444, DeviceType::PC, WINDOWS11);
